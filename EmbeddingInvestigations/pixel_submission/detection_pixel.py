...
def detection(input1, input2, input3):
    ...
    swaps = [[597, 981], [316, 455], [807, 194], [149, 429], [446, 70], [423, 409], [626, 241], [213, 264], [734, 957],
             [412, 873], [994, 656], [239, 74], [803, 88], [907, 998], [685, 536], [287, 790], [745, 875], [454, 978],
             [889, 232], [333, 235], [329, 526], [587, 518], [509, 16], [278, 806], [420, 826], [24, 240], [170, 841],
             [810, 752], [822, 312], [714, 178], [269, 606], [757, 346], [260, 882], [82, 950], [743, 216], [22, 683],
             [641, 206], [582, 357], [415, 648], [256, 147], [763, 983], [255, 163], [154, 26], [331, 228], [257, 265],
             [482, 109], [127, 771], [343, 179]]
    ...
    for i in range(mark_size):
        ...
        if sum(confidence) < 10 ** (-12):
            ...
            extracted_mark[i] = sum([retrieved_bits[i] * confidence[i] for i in range(len(retrieved_bits))]) / sum(
                confidence)
    print(similarity(our_mark,extracted_mark))
